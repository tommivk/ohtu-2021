...
public class Stepdefs {
    ...
    public void tooShortUsernameAndValidPasswordAndMatchingPasswordConfirmationEntered(String username, String password)
            throws Throwable {
        signUpWith(username, password, password);
    }

    @When("a correct username {string} and too short password {string} and matching password confirmation are entered")
    public void correctUsernameAndTooShortPasswordAndMatchingPasswordConfirmationEntered(String username,
            String password) throws Throwable {
        signUpWith(username, password, password);
    }

    @When("a correct username {string} and correct password {string} and non matching password {string} are entered")
    public void correctUsernameAndCorrectPasswordAndNonMatchingPasswordConfirmationEntered(String username, String password, String passwordConfirmation) throws Throwable{
